...
city      = "PRAIA GRANDE"
slug      = "praia_grande"
audio     = "/tmp/praia_grande.mp3"
narration = "Em Praia Grande, agora é diferente. Você ganha seu aparelho e diversos benefícios. Pagando apenas a mensalidade. Clique no link e garanta a sua vaga."

templates = [
    ("01 jan26.mp4", "01jan26"),
    ("02 jan26.mp4", "02jan26"),
    ("03 jan26.mp4", "03jan26"),
    ("04 jan26.mp4", "04jan26"),
]
...
outputs = []
for tpl_file, tpl_slug in templates:
