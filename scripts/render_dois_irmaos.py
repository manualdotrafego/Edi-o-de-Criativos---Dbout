...
city      = "DOIS IRMÃOS"
slug      = "dois_irmaos"
audio     = "/tmp/dois_irmaos.mp3"
narration = "Em Dois Irmãos, agora é diferente! Você ganha o aparelho, documentação, raio-X e um super clareamento. Clique no botão abaixo e garanta a sua vaga!"
...
zip_path = f"{DL}/dois_irmaos_templates.zip"
