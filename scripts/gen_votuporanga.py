...
city      = "VOTUPORANGA"
slug      = "votuporanga"
narration = "Atenção Votuporanga! Últimas 3 vagas para por aparelho dental! com vários benefícios inclusos pagando apenas a mensalidade! Clique agora no link e reserve sua vaga antes que acabe."
...
for tpl_file, tpl_slug, reduce_vol in templates:
    ...
    print(f"▶ {tpl_file}", end=" ... ", flush=True)
...
zip_path = f"{DL}/votuporanga_templates.zip"
